    ...
    <div class="container p-0">
        ...
        <div class="vcard-fifteen main-content mx-auto w-100 overflow-hidden">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-0 pb-0">
                            <div class="profile-name">
                                <h2 class="font-cormorant vcard-profile-name"> {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }}
                                </h2>
            ...
            <div class="contact-section bg-primary position-relative">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-40">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    ...
                                    <p class="mb-0 text-white">{{ $vcard->dob ?? __('messages.vcard.date_of_birth') }}</p>
                                </div>
                            </div>
                        </div>
                        @if($vcard->location)
                        <div class="col-sm-6 mb-40">
                            <div class="contact-box d-flex align-items-center">
                                ...
                                <div class="contact-desc">
                                    <p class="text-primary-light mb-0 fs-14">{{ __('messages.setting.address') }}</p>
                ...
                <svg class="curve-shape {{ checkFeature('services') && $vcard->services->count() ? '' : 'd-none' }}" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 4000 275">
                                ...
                                <div class="gallery-img">
                                    ...
                                    @elseif($file->type == App\Models\Gallery::TYPE_AUDIO)
                                        <div class="audio-container">
                                            <img src="{{ asset('assets/img/music.jpeg') }}" alt="Album Cover" class="audio-image mt-2" height="173">
...
<script>
    const svg = document.getElementsByTagName('svg')[2];
